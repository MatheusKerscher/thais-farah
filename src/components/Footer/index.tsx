const Footer = () => {
  ...
  return (
    <footer className="px-6 md:px-15 pb-5 pt-6 bg-secondary text-gray-400 flex flex-col justify-center items-center text-sm">
      <span className="text-3xl font-kapakana">Dra Thaís Farah</span>
