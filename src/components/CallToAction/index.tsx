    ...
    <section className="px-6 md:px-15">
      ...
      >
        ...
        <p className="text-sm md:text-base text-white text-justify">
          Na minha consulta, toda a atenção está voltada para você. Vamos ouvir
          suas queixas com cuidado, entender o que está acontecendo e definir o
          melhor caminho para o tratamento.
        </p>
