...
const AcademicBackground = () => {
  return (
    <section
      ...
      className="bg-white flex flex-wrap md:flex-nowrap items-center justify-center gap-6 px-6 py-12"
    >
      ...
      <div className="ps-4 flex flex-col border-l-0 md:border-l border-primary text-primary">
